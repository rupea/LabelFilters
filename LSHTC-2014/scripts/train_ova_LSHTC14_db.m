...
%addpath("~/Research/mcfilter/LSHTC-2014/scripts")
...
input_params.C = 100;
input_params.keep_out = false;
input_params.threshold = 0;
...
input_params.filename_fields = "C data.data.min_ex_per_class data.data.min_word_count filter.C1 filter.C2 __HASH";
