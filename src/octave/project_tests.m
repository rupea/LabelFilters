...
project_tests(x,tr_label,xtest,test_labels, pr_func, parameters, exp_name,restarts, resume)
...
if strcmp(pr_func,"find_w")==1
    ...
    [w,min_proj,max_proj, obj_val] = feval(pr_func,x,tr_label,parameters, parameters.no_projections);
end
