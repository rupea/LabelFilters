function [class_acc,class_acc_proj,proj_lbl_ignore,proj_lbl_ignore_percent] = run_multilabel_svm_test(bestC, ...
												      projection_func,exp_name, proj_exp_name, datadir, proj_params, restarts, resume, full_svm = 1, projected_svm=0, onlycorrect=0)
...
## since the parallel svm is loading data from this file, we will load the data here too. 
[x_tr, y_tr, x_ts, y_ts] = load([datadir exp_name ".mat"], "-v6", "y_tr","x_tr","y_te","x_te");
...
if( full_svm ) 
  ...
  [out, out_tr] = perform_parallel_projected_multilabel_svm(exp_name, bestC,"",noClasses, datadir,  "", "", "full", false);
  [macro_acc acc macro_F1 F1 top5 top10] = ...
      evaluate_multilabel_svm_model(y_te, [], out);
endif
