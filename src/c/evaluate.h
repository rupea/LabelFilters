...
void output_perfs(double MicroF1, double  MacroF1, double MacroF1_2, double MicroPrecision, double MacroPrecision, double MicroRecall, double MacroRecall, double Top1, double Top5, double Top10, double Prec1, double Prec5, double Prec10, size_t nact, double total_time, string str="")
{
			 ...
			 size_t& nact, double& total_time)
{
  ...
  predictions = predict(x, ovaW, active, nact, thresh, 10); 
  if (verbose)
    {
  ...
  output_perfs(MicroF1, MacroF1, MacroF1_2, MicroPrecision, MacroPrecision, MicroRecall, MacroRecall, Top1, Top5, Top10, Prec1, Prec5, Prec10, nact, total_time);
}
		   ...
		   size_t& nact, double& total_time)
{
  ...
  size_t foo;
  predictions = predict(x, ovaW, NULL, foo, thresh, 10); 
  if (verbose)
    {
  ...
  output_perfs( MicroF1, MacroF1, MacroF1_2, MicroPrecision, MacroPrecision, MicroRecall, MacroRecall, Top1, Top5, Top10, Prec1, Prec5, Prec10, nact, total_time, "full_");
}
