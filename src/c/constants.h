...
const unsigned int OPT_MAX_ITER = 1e6; 	// Maximum number of iterations
...
const int STOCHASTIC_BATCH_SIZE = 1000; // perform stochastic gradient with this batchsize; if -1 then complete GD
